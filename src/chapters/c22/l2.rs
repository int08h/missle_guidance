//! Chapter 22, Lesson 2: Rate Gyro Autopilot
//!
//! Rate gyro flight control system with feedback.
//! Computes acceleration response with rate gyro feedback loop.
...
pub fn run_and_save(output_dir: &str) -> std::io::Result<Results> {
    ...
    let data_file = format!("{}/c22l2_datfil.txt", output_dir);
    save_data(&data_file, &[
        results.time.clone(),
        results.xnl.clone(),
        results.xncg.clone(),
    ...
    let plot_file = format!("{}/c22l2_accel.png", output_dir);
    let config = PlotConfig::new("Rate Gyro Autopilot - Acceleration Response")
    ...
    println!("C22L2: Simulation finished");
