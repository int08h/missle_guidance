//! Chapter 20, Listing 4: Adjoint with Third-Order Lag Filter
//!
//! Simulates adjoint response to target displacement with a third-order
//! lag filter (8 state variables for closed-loop system).
...
pub fn run_and_save(output_dir: &str) -> std::io::Result<Results> {
    ...
    let data_file = format!("{}/c20l4_datfil.txt", output_dir);
    save_data(&data_file, &data)?;

    println!("C20L4: Simulation complete");
