//! Chapter 26, Lesson 5: Optimal Guidance - 6th Order Riccati Equation
//!
//! Solves the 6th order Riccati differential equation to compute optimal control gains
//! with actuator and gyro dynamics.
...
pub fn run_and_save(output_dir: &str) -> std::io::Result<Results> {
    ...
    let data_file = format!("{}/c26l5_datfil.txt", output_dir);
    save_data(&data_file, &[
        results.time.clone(),
        results.c1.clone(),
        results.c2.clone(),
    ...
    let plot_file = format!("{}/c26l5_gains.png", output_dir);
    let config = PlotConfig::new("Optimal Guidance - 6th Order Control Gains")
    ...
    println!("C26L5: Simulation finished");
