//! Chapter 27, Lesson 4: Target Maneuver Miss with Pre-computed Kalman Gains
//!
//! Similar to L3 but uses time-varying Kalman gains computed beforehand.
...
pub fn run_and_save(output_dir: &str) -> std::io::Result<Results> {
    ...
    let data_file = format!("{}/c27l4_datfil.txt", output_dir);
    save_data(&data_file, &[
        results.tp.clone(),
        results.xmnt.clone(),
        results.k1.clone(),
    ...
    let plot_file = format!("{}/c27l4_miss.png", output_dir);
    let config = PlotConfig::new("Target Maneuver Miss with Pre-computed Gains")
    ...
    println!("C27L4: Simulation finished");
