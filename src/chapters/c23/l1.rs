//! Chapter 23, Lesson 1: Three-Loop Autopilot
//!
//! Autopilot design with actuator dynamics for acceleration control.
...
pub fn run_and_save(output_dir: &str) -> std::io::Result<Results> {
    ...
    let data_file = format!("{}/c23l1_datfil.txt", output_dir);
    save_data(&data_file, &[
        results.time.clone(),
        results.xnl.clone(),
        results.xncg.clone(),
    ...
    let plot_file = format!("{}/c23l1_accel.png", output_dir);
    let config = PlotConfig::new("Three-Loop Autopilot - Acceleration Response")
    ...
    println!("C23L1: Simulation finished");
